...
<div class="row">
    ...
    <form method="post" id="myForm" action="{{ route('category.update') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $editCategory->name }}"   >
                </div>
            </div>
            <!-- end row -->
           
<input type="submit" class="btn mt-5 btn-info btn-rounded waves-effect waves-light" value="Update Category">
