    ...
    <form method="post" id="myForm" action="{{ route('product.update') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text"  value="{{$editProduct->name}}"  >
                </div>
            </div>
            <!-- end row -->
...
<div class="row mb-3">
    ...
    <div class="form-group col-sm-10">
        ...
        <option value="{{ $supplier->id }}" {{ $supplier->id == $editProduct->supplier_id ? 'selected' : '' }} >{{ $supplier->name }}</option>
        @endforeach
        </select>
</div>
</div>
    ...
    <div class="form-group col-sm-10">
        ...
        <option value="{{ $unit->id }}" {{ $unit->id == $editProduct->unit_id ? 'selected' : '' }}>{{ $unit->name }}</option>
        @endforeach
        </select>
</div>
</div>
...
<input type="submit" class="btn mt-5 btn-info btn-rounded waves-effect waves-light" value="Edit Product">
