...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <a href="{{ route('purchase.all') }}" class="btn btn-primary btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-arrow-alt-circle-left">BackTopurchase</i> </a>
            </div>
