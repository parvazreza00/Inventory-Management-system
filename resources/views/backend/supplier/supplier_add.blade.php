...
<div class="row">
    ...
    <form method="post" id="myForm" action="{{ route('supplier.store') }}" enctype="multipart/form-data">
            @csrf
...
<input type="submit" class="btn mt-5 btn-info btn-rounded waves-effect waves-light" value="Add Supplier">
